...
const THRESHOLDS: ThresholdConfig = {
  ...
  scrollDepth: { warning: 0.4, critical: 0.2 }, // below these = bad
  exitRate: { warning: 0.5, critical: 0.7 },
};
  ...
  "rationale": "..."
    ...
    try {
      const response = await llm.extractJson<{
        ...
        `generate-options-${issue.metric}-${issue.pagePath}`,
      );
...
function getStaticOptions(issue: DetectedIssue): ActionOption[] {
  const optionSets: Record<string, ActionOption[]> = {
    bounce_rate: [
      {
        id: "a",
        label: "Rewrite CTA copy",
        description: "Update the call-to-action to be more compelling and action-oriented",
        riskLevel: "low",
        reversible: true,
        recommended: true,
        confidence: 0.7,
      ...
      {
        id: "b",
        label: "Add social proof above fold",
        description: "Insert testimonials or trust badges near the top of the page",
        riskLevel: "low",
        reversible: true,
        recommended: false,
        confidence: 0.6,
      ...
      {
        id: "c",
        label: "Redesign page layout",
        description: "Restructure the page to improve visual hierarchy and scannability",
        riskLevel: "medium",
        reversible: true,
        recommended: false,
        confidence: 0.5,
      ...
      {
        id: "d",
        label: "Remove page from navigation",
        description: "Remove this underperforming page and redirect traffic elsewhere",
        riskLevel: "high",
        reversible: false,
        recommended: false,
        confidence: 0.3,
    ...
    time_on_page: [
      {
        id: "a",
        label: "Add more detailed content",
        description: "Expand the page with more in-depth information and examples",
        riskLevel: "low",
        reversible: true,
        recommended: true,
        confidence: 0.7,
      },
      {
        ...
        description: "Include frequently asked questions to increase engagement",
        riskLevel: "low",
        reversible: true,
        recommended: false,
        confidence: 0.65,
      },
      {
        ...
        description: "Embed a relevant video to increase time on page",
        riskLevel: "low",
        reversible: true,
        recommended: false,
        confidence: 0.6,
      },
      {
        id: "d",
        label: "Do nothing",
        description: "Monitor for another week before taking action",
        riskLevel: "low",
        reversible: true,
        recommended: false,
        confidence: 0.3,
    ...
    scroll_depth: [
      {
        id: "a",
        label: "Move key content higher",
        description: "Restructure to put the most important information above the fold",
        riskLevel: "low",
        reversible: true,
        recommended: true,
        confidence: 0.7,
      },
      {
        ...
        description: "Insert images, icons, or section dividers to encourage scrolling",
        riskLevel: "low",
        reversible: true,
        recommended: false,
        confidence: 0.6,
      ...
      {
        id: "c",
        label: "Shorten the page",
        description: "Remove less relevant content to improve content density",
        riskLevel: "medium",
        reversible: true,
        recommended: false,
        confidence: 0.5,
      },
      {
        ...
        description: "Show a reading progress bar to encourage completion",
        riskLevel: "low",
        reversible: true,
        recommended: false,
        confidence: 0.4,

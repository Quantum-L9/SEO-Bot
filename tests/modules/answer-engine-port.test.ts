...
import { getAnswerEnginePort, PerplexityAnswerEnginePort } from '../../src/modules/aeo-geo/answer-engine-port.js';
...
describe('AnswerEngineObservationPort (Perplexity)', () => {
  it('confines the direct provider call and returns content + citations', async () => {
    post.mockResolvedValue({
      data: { choices: [{ message: { content: 'answer' } }], citations: ['https://alpha.com', 'https://beta.com'] },
    });
